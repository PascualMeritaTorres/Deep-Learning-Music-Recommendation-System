...
from ..paths import BINARY_PATH,TEST_PATH,MODEL_LOAD_PATH,DATA_NUMPY_PATH
...
@click.option('--data_path', type=str, default=DATA_NUMPY_PATH, help='path to data directory')

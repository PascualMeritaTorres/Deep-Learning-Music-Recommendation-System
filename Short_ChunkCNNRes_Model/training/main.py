...
from paths import MP3_DATA_PATH,MODEL_LOAD_PATH,MODEL_SAVE_PATH
...
@click.option('--number_of_epochs', type=int, default=60, help='number of epochs to train')
@click.option('--batch_size', type=int, default=4, help='number of samples passed through to the network at one time')
...
@click.option('--data_path', type=str, default=MP3_DATA_PATH, help='path to the data directory')
@click.option('--log_step', type=int, default=20, help='number of steps to log')
def run(parallel_threads,number_of_epochs, batch_size, learning_rate, use_tensorboard, model_save_path, model_load_path, data_path, log_step):
    """
